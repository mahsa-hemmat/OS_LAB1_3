...
extern int sys_set_HRRN_priority_proc(void);
extern int sys_set_HRRN_priority_sys(void);
...
[SYS_set_HRRN_priority_proc]    sys_set_HRRN_priority_proc,
[SYS_set_HRRN_priority_sys]     sys_set_HRRN_priority_sys,
